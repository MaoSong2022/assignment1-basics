...
def run_multihead_self_attention(
    ...
    """
    attention_layer = model.MultiHeadAttention(d_model, num_heads)
...
def run_multihead_self_attention_with_rope(
    ...
    cos, sin = rotary_embedding(in_features, token_positions)
    return attention_layer(in_features, cos, sin)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return model_utils.softmax(in_features, dim=-1)
...
def run_cross_entropy(
    ...
    """
    return model_utils.cross_entropy_loss(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    model_utils.gradient_clipping(parameters, max_l2_norm)
